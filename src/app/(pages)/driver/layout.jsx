    ...
    return (
        <div className="user_dashboard flex min-h-screen">
                ...
                <div className="flex flex-col justify-between h-[calc(100%-130px)] mt-10">
                    <ul className="space-y-3">
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
                                <BiHome className="w-6 h-6" />
                                <span className={`ml-3 text-base ${!isSidebarOpen && "hidden"} transition-all duration-300`}>Dashboard</span>
                            </Link>
                        </li>
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver/lessons" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
                        ...
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver/license" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
                                <TbLicense className="w-6 h-6" />
                                <span className={`ml-3 text-base ${!isSidebarOpen && "hidden"} transition-all duration-300`}>License</span>
                            </Link>
                        </li>
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver/documents" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
                        ...
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver/Payments" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
                        ...
                        <li className="text-black hover:text-blue-500 cursor-pointer">
                            <Link href="/driver/Profile" className={`flex items-center p-3 ${!isSidebarOpen ? "justify-center" : "justify-start"}`}>
            ...
            <section className={`flex-1 min-h-screen z-40 transition-all duration-75 bg-white ${isSidebarOpen ? "pl-64" : "pl-16"}`}>
                ...
                {isPopupOpen && <DriverRating type={"driver"} onClose={handleClosePopup} />}
