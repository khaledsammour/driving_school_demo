...
export default function TableDocument() {
    ...
    useEffect(() => {
        const fetchDocuments = async () => {
            setLoading(true);
            try {
                const q = query(collection(db, "uploads"), where("fileType", "==", "document"));
    ...
    const sendMessageToUser = async (userId, status) => {
        try {
            ...
            const message = status === "Accepted" ? "Your document has been accepted." : "Your document has been rejected.";
